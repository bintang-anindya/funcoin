...
const App = () => {
  return (
    <div className="flex flex-col min-h-screen font-sans bg-black text-gray-200 overflow-x-hidden">
      {/* ====== NAVBAR ====== */}
      ...
      {/* ====== MAIN CONTENT (biar footer nempel bawah) ====== */}
      <main className="flex-grow">
        ...
        >
          ...
          >
            ...
            ultimate asymmetric bet in the AI race. It changes the game
            overnight!
          </motion.p>
      ...
      <footer className="py-4 sm:py-5 text-center text-gray-500 bg-gray-900/60 border-t border-gray-800 text-xs sm:text-sm tracking-wide backdrop-blur-sm mt-auto">
        <p>
          © 2025{" "}
          <span className="text-white font-orbitron">Grok Singularity</span> — Built
